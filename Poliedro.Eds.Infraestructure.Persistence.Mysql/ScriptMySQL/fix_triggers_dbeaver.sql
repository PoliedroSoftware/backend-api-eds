-- ========================================
-- SCRIPT SIMPLIFICADO PARA DBEAVER
-- Actualizar triggers de auditoría
-- Base de datos: eds
-- ========================================
...
-- PASO 2: Crear trigger para hose
...
-- PASO 3: Crear trigger para product
...
-- PASO 4: Crear trigger para tank
...
-- PASO 5: Verificar que los triggers fueron creados
SELECT 
    TRIGGER_NAME, 
    EVENT_OBJECT_TABLE,
