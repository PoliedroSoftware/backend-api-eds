...
public class CompartimentCapacityGetAllService(ITenantDbContextFactory dbContextFactory, ILogger<CompartimentCapacityGetAllService> logger) : ICompartimentCapacityGetAllService
{
