...
public class CompartimentViewConfiguration
{
    public CompartimentViewConfiguration(EntityTypeBuilder<CompartimentViewEntity> builder)
    {
        builder.ToTable("v_compartiment");
