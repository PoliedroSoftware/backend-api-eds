...
public static class DashboardPowerBIEndpoints
{
    public static IEndpointRouteBuilder MapDashboardPowerBIEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("api/v1/dashboard")
            .WithTags("DashboardPowerBI");

        group.MapGet("capacities", GetCapacities)
            .WithName("GetDashboardCapacities")
            .WithSummary("Get all capacities for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("compartiments", GetCompartiments)
            .WithName("GetDashboardCompartiments")
            .WithSummary("Get all compartiments for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("courts", GetCourts)
            .WithName("GetDashboardCourts")
            .WithSummary("Get all courts for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("business", GetBusiness)
            .WithName("GetDashboardBusiness")
            .WithSummary("Get all business for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("eds", GetEds)
            .WithName("GetDashboardEds")
            .WithSummary("Get all EDS for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("inventories", GetInventories)
            .WithName("GetDashboardInventories")
            .WithSummary("Get all inventories for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);
        ...
        group.MapGet("products", GetProducts)
            ...
            .WithSummary("Get all products for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("providers", GetProviders)
            .WithName("GetDashboardProviders")
            .WithSummary("Get all providers for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("shopping", GetShopping)
            .WithName("GetDashboardShopping")
            .WithSummary("Get all shopping for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("shopping-products", GetShoppingProducts)
            .WithName("GetDashboardShoppingProducts")
            .WithSummary("Get all shopping products for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);

        group.MapGet("type-of-collections", GetTypeOfCollections)
            .WithName("GetDashboardTypeOfCollections")
            .WithSummary("Get all type of collections for Power BI dashboard")
            .RequireAuthorization("AdminOrIslander")
            .Produces(StatusCodes.Status200OK)
            .Produces<ProblemDetails>(StatusCodes.Status404NotFound);
    ...
    private static async Task<IResult> GetCapacities(
    ...
    private static async Task<IResult> GetCompartiments(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
    ...
    private static async Task<IResult> GetEds(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
    ...
    private static async Task<IResult> GetInventories(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
    ...
    private static async Task<IResult> GetShopping(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
    ...
    private static async Task<IResult> GetShoppingProducts(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
        var data = await mediator.Send(new GellAllShoppingProductViewQuery(new PaginationParams 
        { 
            PageNumber = pageNumber, PageSize = pageSize 
        }));
    ...
    private static async Task<IResult> GetTypeOfCollections(
        [FromQuery] int pageNumber = 1,
        [FromQuery] int pageSize = 10,
        IMediator mediator = null!)
    {
