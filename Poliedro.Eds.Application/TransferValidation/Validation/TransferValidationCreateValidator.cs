...
namespace Poliedro.Eds.Application.TransferValidation.Validation;

public class TransferValidationCreateValidator : AbstractValidator<TransferValidationCreateRequestDto>
{
    public TransferValidationCreateValidator()
    {
        RuleFor(x => x.UniqueId)
            .NotEmpty()
            .WithMessage("El ID único es requerido")
            .MaximumLength(50)
            .WithMessage("El ID único no puede exceder 50 caracteres");
